...
export class  $npmConfigName1744827851751 implements MigrationInterface {
    name = ' $npmConfigName1744827851751'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notifications" ADD "iconStyle" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notifications" DROP COLUMN "iconStyle"`);
    }
