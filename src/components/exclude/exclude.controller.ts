...
export class ExcludeController {
  ...
  @ApiOperation({
    ...
    description: 'Registra uma solicitação de exclusão de conta.',
  })
  ...
  @ApiOperation({
    summary: 'Marcar conta como excluída',
    description: 'Marca uma solicitação como já processada/excluída.',
  })
