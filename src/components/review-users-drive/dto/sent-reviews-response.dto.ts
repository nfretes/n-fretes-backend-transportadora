...
export class SentReviewDto {
  ...
  @ApiProperty({ example: 'Excelente motorista! Muito profissional.' })
  comment: string;
  ...
  @ApiProperty({ example: ['OTIMO_MOTORISTA', 'PONTUAL'] })
  tags: string[];
...
export class SentReviewsResponseDto {
  @ApiProperty({ type: [SentReviewDto] })
  data: SentReviewDto[];
